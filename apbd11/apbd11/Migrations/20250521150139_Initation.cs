    ...
    public partial class Initation : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 5, 21, 17, 1, 39, 257, DateTimeKind.Local).AddTicks(1451), "Jan", "Kowalski" },
                    { 2, new DateTime(2025, 5, 21, 17, 1, 39, 258, DateTimeKind.Local).AddTicks(3902), "Kamil", "Nowak" }
                });
